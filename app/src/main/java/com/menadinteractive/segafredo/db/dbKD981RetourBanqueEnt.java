...
public class dbKD981RetourBanqueEnt extends dbKD{
	...
	//Montant cheque portefeuille
	public final String FIELD_RHBQ_MNT_CHEQUE_CHP = fld_kd_dat_data09;
	//Montant cheque all
	public final String FIELD_RHBQ_MNT_CHEQUE_ALL = fld_kd_dat_data10;
	...
	static public class structRetourBanque {
		...
		public String MNT_CHEQUE_CHP="";
		public String MNT_CHEQUE_ALL="";
	...
	public boolean insertRetourBanque(structRetourBanque retourbanque){
		...
		try{
			...
			query = "INSERT INTO "
					...
					+ ","
					+ this.FIELD_RHBQ_MNT_CHEQUE_CHP
					+ ","
					+ this.FIELD_RHBQ_MNT_CHEQUE_ALL
					+ ","
					...
					+ ","
					+ "'"+retourbanque.MNT_CHEQUE_CHP+"'"
					+ ","
					+ "'"+retourbanque.MNT_CHEQUE_ALL+"'"
					+ ","
			...
			Global.dbLog.Insert("981RETOURBANQUE", "INSERT", "", "",  query, "", "");
	...
	public structRetourBanque getRemiseBanque(String numRemise){
		...
		if (cur!=null)
		{
			if(cur.moveToNext())
			{
				...
				remise.MNT_CHEQUE_CHP = this.giveFld(cur,this.FIELD_RHBQ_MNT_CHEQUE_CHP);	
				remise.MNT_CHEQUE_ALL = this.giveFld(cur,this.FIELD_RHBQ_MNT_CHEQUE_ALL);	
