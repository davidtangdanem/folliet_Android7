...
*/
	...
	public static String FIELD_CLI_PERIODICITE				= "CLI_PERIODICITE";
	public static String FIELD_CLI_TOURNEE					= "CLI_TOURNEE";
	public static String FIELD_CLI_ANNUEL					= "CLI_ANNUEL";
	public static String FIELD_CLI_AGENT2					= "CLI_AGENT2";
	public static String FIELD_CLI_SAISON_ETE					= "CLI_SAISON_ETE";
	public static String FIELD_CLI_SAISON_HIVER					= "CLI_SAISON_HIVER";
	public static String FIELD_CLI_ACTIVITE_P					= "CLI_ACTIVITE_P";
	public static String FIELD_CLI_FAMCLIENT					= "CLI_FAMCLIENT";
	public static String FIELD_CLI_SFAMCLIENT					= "CLI_SFAMCLIENT";
	public static String FIELD_CLI_STANDBY					= "CLI_STANDBY";
	public static String FIELD_CLI_DATECLI					= "CLI_DATECLI";
	public static String FIELD_CLI_CLASSE					= "CLI_CLASSE";
	public static String FIELD_CLI_PASMAIL					= "CLI_PASMAIL";
	public static String FIELD_CLI_VOl_CAFE_ANNUEL			= "VOl_CAFE_ANNUEL";
	public static String FIELD_CLI_POT_CA				= "POT_CA";
	public static String FIELD_CLI_PLACEASSINT			= "PLACEASSINT";
	public static String FIELD_CLI_PLACEASSEXT			= "PLACEASSEXT";
	public static String FIELD_CLI_CAPACITE_SDR			= "CAPACITE_SDR";
	public static String FIELD_CLI_NB_CHAMBRES			= "NB_CHAMBRES";
	public static String FIELD_CLI_NB_LITS				= "NB_LITS";
	public static String FIELD_CLI_QUALIF				= "QUALIF";
	public static String FIELD_CLI_SITUATION			= "SITUATION";
	public static String FIELD_CLI_OPTION_P				= "OPTION_P";
	public static String FIELD_CLI_TYPECUISINE			= "TYPECUISINE";
	public static String FIELD_CLI_PV_CAFE				= "PV_CAFE";
	public static String FIELD_CLI_PV_THE				= "PV_THE";
	public static String FIELD_CLI_PV_CHOCOLAT			= "PV_CHOCOLAT";
	public static String FIELD_CLI_PV_PETIT_DEJ			= "PV_PETIT_DEJ";
	public static String FIELD_CLI_PV_CHAMBRE			= "PV_CHAMBRE";
	public static String FIELD_CLI_STD_BY				= "STD_BY";
	public static String FIELD_CLI_INFO_TERRAIN           = "INFOTERRAIN";
	public static String FIELD_CLI_ENVOIFACT_PAR_MAIL           = "ENVOIFACT_PAR_MAIL";
	...
	public static final String KD_INSERT_STRING=
		 ...
		 FIELD_CLI_ACTIF	  		+","+
		 FIELD_CLI_FLAG	  			+","+
		FIELD_CLI_PERIODICITE	  	+","+
		FIELD_CLI_TOURNEE	  		+","+
		FIELD_CLI_ANNUEL	  		+","+
		FIELD_CLI_AGENT2	  		+","+
		FIELD_CLI_SAISON_ETE	  	+","+
		FIELD_CLI_SAISON_HIVER	  	+","+
		FIELD_CLI_ACTIVITE_P	  	+","+
		FIELD_CLI_FAMCLIENT	  		+","+
		FIELD_CLI_SFAMCLIENT	  	+","+
		FIELD_CLI_STANDBY	  		+","+
		FIELD_CLI_DATECLI	  		+","+
		FIELD_CLI_CLASSE	  		+","+
		FIELD_CLI_PASMAIL	  		+","+
		FIELD_CLI_VOl_CAFE_ANNUEL   +","+
		FIELD_CLI_POT_CA   			+","+
		FIELD_CLI_PLACEASSINT   	+","+
		FIELD_CLI_PLACEASSEXT   	+","+
		FIELD_CLI_CAPACITE_SDR  	+","+
		FIELD_CLI_NB_CHAMBRES   	+","+
		FIELD_CLI_NB_LITS   		+","+
		FIELD_CLI_QUALIF   			+","+
		FIELD_CLI_SITUATION   		+","+
		FIELD_CLI_OPTION_P   		+","+
		FIELD_CLI_TYPECUISINE   	+","+
		FIELD_CLI_PV_CAFE   		+","+
		FIELD_CLI_PV_THE   			+","+
		FIELD_CLI_PV_CHOCOLAT   	+","+
		FIELD_CLI_PV_PETIT_DEJ  	+","+
		FIELD_CLI_PV_CHAMBRE   		+","+
		FIELD_CLI_STD_BY   			+","+
		FIELD_CLI_INFO_TERRAIN		+","+
		FIELD_CLI_ENVOIFACT_PAR_MAIL+","+
		FIELD_CLI_LAT	  			+","+
