...
public class dbKD729HistoDocuments extends dbKD {
	...
	public final static String FIELD_MNT_PIE 	= fld_kd_dat_data16;
...
//
	...
	public ArrayList<Bundle> get(String codecli ,String numdoc ,String typedoc) {
		...
		while (cur.moveToNext() ) {
			...
			if (typedoc.toUpperCase().equals(TableSouches.TYPEDOC_PORTEFEUILLE)) icon="facture";
	...
	public ArrayList<Bundle> getWihtoutRG(String codecli ,String numdoc ,String typedoc,String typeImpaye,String typeOD,String typeEcart) {
		...
		if (numdoc.equals("")==false)
			query+=" and "+FIELD_NUMDOC+"='"+numdoc+"'";
		if (typedoc.equals("")==false)
			query+=" and ( "+FIELD_TYPEDOC+"!='"+typedoc+"' and "+FIELD_TYPEDOC+"!='"+typeOD+"' and "+FIELD_TYPEDOC+"!='"+typeEcart+"' and "+FIELD_TYPEDOC+"!='"+typeImpaye+"' ) ";
	...
	public ArrayList<Bundle> getLinesFromCodeClientAndType(String codecli, String type) {
		...
		query+=" and "+FIELD_TYPEDOC+"='"+type+"'";

		query+=" order by "+ FIELD_DATEDOC+" desc";

		Log.e("query getLinesFrom",""+query);
	...
	public String LastFacture(String codecli  ) {
		...
		if (codecli.equals("")==false)
			query+=" and "+FIELD_CODECLIENT+"='"+codecli+"'";
		query+=" and "+FIELD_TYPEDOC+"='FA'";

		query+=" order by "+ FIELD_DATEDOC+" desc";

		Cursor cur = db.conn.rawQuery(query, null);
		while (cur.moveToNext() ) {
			lastDate= Fonctions.YYYY_MM_DD_to_dd_mm_yyyy(cur.getString(cur.getColumnIndex(FIELD_DATEDOC 	)));
			break;
		}
		if (cur!=null)
			cur.close();
