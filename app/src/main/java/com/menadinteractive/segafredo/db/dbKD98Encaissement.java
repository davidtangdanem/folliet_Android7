...
public class dbKD98Encaissement extends dbKD{
	...
	//Identifiant
	public final String FIELD_ENC_IDENTIFIANT = fld_kd_dat_idx01;
	//Code agent
...
//		}
	...
	public boolean insertEncaissement(Encaissement encaissement, String codeAgent){
		...
		try{
			...
			db.conn.execSQL(query);
			Global.dbLog.Insert("98ENCAISSEMENT", "INSERT", "", query, "","", "");
			return true;
		}catch(SQLException ex){
			return false;
		}
...
//					dbKD.fld_kd_dat_type+"='"+KD_TYPE+"' and "+
//					FIELD_ENC_ETAT_RBANQUE
//					+"='1' and  "+ FIELD_ENC_DATE+"<"+Fonctions.getDay_Monday_Courant()+"";
...
//					+"='1'  and "+ FIELD_ENC_DATE+"<"+Fonctions.getDay_Monday_Courant()+"";
	...
	public boolean DeleteEncaissementNonRB( ){
		try
		{
