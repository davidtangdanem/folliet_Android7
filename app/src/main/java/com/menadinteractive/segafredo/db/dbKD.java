...
public class dbKD extends DBMain {
	...
	/*public static final String INDEX1_CREATE="CREATE INDEX IF NOT EXISTS ixcde_code ON "+TABLENAME+
			" ("+ fld_kd_cde_code+ ")";
	public static final String INDEX2_CREATE="CREATE INDEX IF NOT EXISTS ixpro_code ON "+TABLENAME+
			" ("+ fld_kd_pro_code+ ")";
	public static final String INDEX3_CREATE="CREATE INDEX IF NOT EXISTS ixcli_code ON "+TABLENAME+
			" ("+ fld_kd_cli_code+ ")";	
	public static final String INDEX4_CREATE="CREATE INDEX IF NOT EXISTS ixdat_type ON "+TABLENAME+
			" ("+ fld_kd_dat_type+ ")";*/
	
	public static final String INDEX5_CREATE="CREATE INDEX IF NOT EXISTS ixcde_code ON "+TABLENAME_HISTO+
			" ("+ fld_kd_cde_code+ ")";
	public static final String INDEX6_CREATE="CREATE INDEX IF NOT EXISTS ixpro_code ON "+TABLENAME_HISTO+
			" ("+ fld_kd_pro_code+ ")";
	public static final String INDEX7_CREATE="CREATE INDEX IF NOT EXISTS ixcli_code ON "+TABLENAME_HISTO+
			" ("+ fld_kd_cli_code+ ")";	
	public static final String INDEX8_CREATE="CREATE INDEX IF NOT EXISTS ixdat_type ON "+TABLENAME_HISTO+
			" ("+ fld_kd_dat_type+ ")";
	
	
	/*public static final String INDEX8_DROP="DROP INDEX ixdat_type ON "+TABLENAME_HISTO+
			" ("+ fld_kd_dat_type+ ")";*/
	
	//public static final String INDEX8_DROP="DROP INDEX ixdat_type ON "+TABLENAME_HISTO;
	
	public static final String INDEX5_DROP="DROP INDEX  IF EXISTS  ixcde_code";
	public static final String INDEX6_DROP="DROP INDEX  IF EXISTS  ixpro_code";
	public static final String INDEX7_DROP="DROP INDEX IF EXISTS   ixcli_code";
	public static final String INDEX8_DROP="DROP INDEX IF EXISTS  ixdat_type";
