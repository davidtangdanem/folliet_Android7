...
public class dbSiteListeLogin extends DBMain{
	public String TABLENAME="SITE_LISTLOGINV9";
	...
	public final String FIELD_LOGIN_TYPE         ="TYPE"  ; // TECH et RA   
	...
	public final String FIELD_LOGIN_GSM2        ="GSM2"  ;    //gsm
	...
	{	
		try
		{
			...
			if (cur.moveToNext())
			{
				...
				rep.GSM2        =giveFld(cur,FIELD_LOGIN_GSM2        );
	...
	public String getAgence(String login)
	{	
		String agence="";
		try
		{
			...
			if (cur.moveToNext())
			{
				...
				agence        =Fonctions.GetStringDanem(giveFld(cur,FIELD_LOGIN_IMAGES        ));
