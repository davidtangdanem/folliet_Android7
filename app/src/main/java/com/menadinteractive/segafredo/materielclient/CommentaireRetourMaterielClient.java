...
implements OnItemSelectedListener{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		m_par_ref= bundle.getString("par_ref");
	...
	void Loadinformation()
	{
		...
		this.setEditViewText(this,R.id.EditLibart,m_par_ref);
	...
	public boolean save( )
	{
		try
		{
			...
			retour.DESIGNATION=m_designation;
			retour.RMC_REFMACHINE=m_par_ref;
	...
	void InitTextView()
	{
		...
		TexteSZ.setVisibility(View.GONE);
