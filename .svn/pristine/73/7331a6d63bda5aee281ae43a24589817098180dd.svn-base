...
public class Espresso {
	...
	public static final String PREF_CARTOPROXIMITE="CartoProximite";
	...
	public static final String CODE_TOURNEE="tournee_code";
	public static final String DATESYNCHRO="datesynchro";		//pour bloquer les modifiaction client et propect si 'pas recent'
