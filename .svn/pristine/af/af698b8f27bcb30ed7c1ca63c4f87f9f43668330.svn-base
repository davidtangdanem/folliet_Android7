...
public class Encaissement {
	...
	public static ArrayList<Encaissement> getEncaissementFromNumeroFacture(String numeroFacture, String codeClient, String validation){
		if (numeroFacture == null || numeroFacture.equals(""))
			return null;

		ArrayList<Encaissement> encaissements = new ArrayList<Encaissement>();
		ArrayList<String> numeros = Global.dbKDEncaisserFacture.getNumerosEncaissementFromNumeroFacture(numeroFacture);
	...
	public Encaissement saveEncaissement(ArrayList<String> numerosFacture, String codeAgent){		
		...
		this.identifiant = generateNewIdentifiantEncaisserFacture();
		...
		if(this.identifiant != null && !this.identifiant.equals("")) {
			...
			for(String num : numerosFacture){
				boolean result = Global.dbKDEncaisserFacture.insertEncaissement(generateNewIdentifiantEncaisserFacture(), 
	 ...
	 * @return String identifiant
	 */
	public static String generateNewIdentifiantEncaisserFacture(){
		if(Global.dbKDEncaisserFacture == null) return null;
		String maxIdentifiant = Global.dbKDEncaisserFacture.selectMaxIdentifiant();
		if(maxIdentifiant == null || maxIdentifiant.equals("")) return "1";
		else{
			int max = 0;
			try{
