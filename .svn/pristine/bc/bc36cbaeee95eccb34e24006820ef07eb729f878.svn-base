...
public static  String TABLENAME="kems_log";
	...
	public final static String FLD_LOG_REQUETE = "requete"; //requete
	...
	public static String ALTER_REQUETE="ALTER TABLE "+
			TABLENAME+
			" ADD  "+FLD_LOG_REQUETE+" TEXT";
	...
	public boolean   Insert( String ecran,String fonction,String params,String message, String requete, String exception,String complement)
	{
		//return false;
