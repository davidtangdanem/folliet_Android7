...
public class dbKD730FacturesDues extends dbKD {
	...
	public final String FIELD_NIVEAU 	= fld_kd_dat_data03;
	public final String FIELD_NBJRRETARD = fld_kd_dat_data04;
	public final String FIELD_TYPRELANCE = fld_kd_dat_data05;
	public final String FIELD_FLAG_TECH = fld_kd_dat_data06;
	public final String FIELD_MNT_PIE = fld_kd_dat_data07;
	...
	public int Count(String codecli)
	{
	 ...
	 public ArrayList<Bundle> get(  String orderby) {
		...
		while (cur.moveToNext() ) {
			...
			b.putString(FIELD_NIVEAU	, cur.getString(cur.getColumnIndex(FIELD_NIVEAU	)));
			b.putString(FIELD_NIVEAU	, cur.getString(cur.getColumnIndex(FIELD_NIVEAU	)));
			b.putString(FIELD_FLAG_TECH	, cur.getString(cur.getColumnIndex(FIELD_FLAG_TECH	)));
			b.putString(FIELD_MNT_PIE	, cur.getString(cur.getColumnIndex(FIELD_MNT_PIE	)));
	 ...
	 public ArrayList<Bundle> getFacturesDuesFromCodeClient(String codeClient) {
			...
			while (cur.moveToNext() ) {
				...
				b.putString(FIELD_NIVEAU	, cur.getString(cur.getColumnIndex(FIELD_NIVEAU	)));
				b.putString(FIELD_NBJRRETARD, cur.getString(cur.getColumnIndex(FIELD_NBJRRETARD	)));
				b.putString(FIELD_FLAG_TECH	, cur.getString(cur.getColumnIndex(FIELD_FLAG_TECH	)));
				b.putString(FIELD_MNT_PIE	, cur.getString(cur.getColumnIndex(FIELD_MNT_PIE	)));
