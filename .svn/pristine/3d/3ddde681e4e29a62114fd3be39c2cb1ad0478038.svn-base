...
public class ApplicationLauncher {
	...
	private static Intent danembr = new Intent()
			.setClassName("com.danem.br",
					"com.danem.br.BarcodeCaptureActivity");
	...
	public static boolean isDanemBRAvailable(Context context){
		return isApplicationAvailable(context, danembr);
	}
