...
public class TableSouches extends DBMain{
	...
	public static final String TYPEDOC_BC				= "BC";
	public static final String TYPEDOC_COMMANDE			= "CR";
	public static final String TYPEDOC_INTERVENTION 	= "IN";
	public static final String TYPEDOC_PORTEFEUILLE 	= "CD";
	public static final String TYPEDOC_BCOMMANDE	 	= "CO";
	public static final String TYPEDOC_PROFORMA	 	    = "PR";
    public static final String TYPEDOC_RELEVELINEAIRE	 	= "RL";

	
	
	
	public static final String TYPEDOC_IMPAYES 			= "IM";
	public static final String TYPEDOC_OD 				= "OD";	
	public static final String TYPEDOC_ECART			= "EC";
	
	public static final String TYPEDOC_PROSPECT				= "CL";
	
	public static final String TYPEDOC_RAPPORT				= "RA";
