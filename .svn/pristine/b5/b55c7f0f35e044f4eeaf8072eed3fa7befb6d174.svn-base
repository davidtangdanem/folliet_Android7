...
public class ListingMaterielClient extends BaseActivity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		m_numfab =  bundle.getString("numfab");
		...
		Handler h = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case R.id.iv2:
					...
					launchMenuCommentaireRetour(m_codeclient,"",numserie,codemateriel,designation);
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case 1:
			...
			if(bres==true)
		    	launchMenuCommentaireRetour(m_codeclient,"",numserie,codemateriel,designation,par_ref);
	...
	void launchMenuCommentaireRetour(String contactcli,String SZ,String numserie,String codemateriel ,String designation,String par_ref)
	{
	...
	private void PopulateList() {
		 ...
		 cli=Global.dbMaterielClient.getMaterielClientFilters(m_codeclient, "",m_numfab);
